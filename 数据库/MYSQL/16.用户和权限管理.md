...
登录发现只能查看数据库中的`information_schema`库
...
mysql使用`default_password_lifetime`系统变量建立全局密码过期测。
...
![image-20221015224952066](img.assets\image-20221015224952066.png)
...
**资源控制列的字段用来限制用户使用的资源**，user 表中的资源控制列如下图所示。
